...
bool qsctest_sha3_256_kat()
{
	...
	qsc_sha3_update(&state, QSC_KECCAK_256_RATE, msg0, 0);
	qsc_sha3_finalize(&state, QSC_KECCAK_256_RATE, hash);
	...
	qsc_intutils_clear8(hash, sizeof(hash));
	qsc_sha3_initialize(&state);
	qsc_sha3_update(&state, QSC_KECCAK_256_RATE, msg24, sizeof(msg24));
	qsc_sha3_finalize(&state, QSC_KECCAK_256_RATE, hash);
	...
	qsc_sha3_initialize(&state);
	/* absorb the message */
	qsc_sha3_update(&state, QSC_KECCAK_256_RATE, msg448, sizeof(msg448));
	qsc_sha3_finalize(&state, QSC_KECCAK_256_RATE, hash);
	...
	qsc_sha3_initialize(&state);
	/* absorb the message */
	qsc_sha3_update(&state, QSC_KECCAK_256_RATE, msg1600, sizeof(msg1600));
...
bool qsctest_sha3_512_kat()
{
	...
	/* initialize the SHA3 state structure */
	qsc_sha3_initialize(&state);
	qsc_sha3_update(&state, QSC_KECCAK_512_RATE, msg0, 0);
	qsc_sha3_finalize(&state, QSC_KECCAK_512_RATE, hash);
	...
	qsc_intutils_clear8(hash, sizeof(hash));
	qsc_sha3_initialize(&state);
	qsc_sha3_update(&state, QSC_KECCAK_512_RATE, msg24, sizeof(msg24));
	qsc_sha3_finalize(&state, QSC_KECCAK_512_RATE, hash);
	...
	qsc_intutils_clear8(hash, sizeof(hash));
	qsc_sha3_initialize(&state);
	qsc_sha3_update(&state, QSC_KECCAK_512_RATE, msg448, sizeof(msg448));
	qsc_sha3_finalize(&state, QSC_KECCAK_512_RATE, hash);
	...
	qsc_sha3_initialize(&state);
	/* absorb the message */
	qsc_sha3_update(&state, QSC_KECCAK_512_RATE, msg1600, sizeof(msg1600));
	/* finalize the message */
	qsc_sha3_finalize(&state, QSC_KECCAK_512_RATE, hash);
...
bool qsctest_shake_128_kat()
{
	...
	uint8_t hash[QSC_KECCAK_128_RATE * 4] = { 0 };
	uint8_t msg0[1] = { 0 };
	uint8_t msg1600[200] = { 0 };
	...
	qsc_shake_initialize(&state, QSC_KECCAK_128_RATE, msg1600, sizeof(msg1600));
	qsc_shake_squeezeblocks(&state, QSC_KECCAK_128_RATE, hash, 4);
...
bool qsctest_shake_256_kat()
{
	uint8_t exp0[512] = { 0 };
	uint8_t exp1600[512] = { 0 };
	uint8_t hash[QSC_KECCAK_256_RATE * 4] = { 0 };
	uint8_t msg0[1] = { 0 };
	uint8_t msg1600[200] = { 0 };
	uint8_t output[512] = { 0 };
	qsc_keccak_state state;
	...
	qsc_intutils_clear8(hash, sizeof(hash));
	qsc_intutils_clear64(state.state, QSC_KECCAK_STATE_SIZE);
	qsc_shake_initialize(&state, QSC_KECCAK_256_RATE, msg1600, sizeof(msg1600));
	qsc_cshake_squeezeblocks(&state, QSC_KECCAK_256_RATE, hash, 4);
...
bool qsctest_shake_512_kat()
{
	uint8_t exp1[512] = { 0 };
	uint8_t exp2[512] = { 0 };
	uint8_t hash[QSC_KECCAK_512_RATE * 8] = { 0 };
	uint8_t msg1[64] = { 0 };
	uint8_t msg2[200] = { 0 };
	uint8_t output[512] = { 0 };
	qsc_keccak_state state;
	...
	qsc_intutils_clear8(output, sizeof(output));
	qsc_intutils_clear64(state.state, QSC_KECCAK_STATE_SIZE);
	qsc_shake_initialize(&state, QSC_KECCAK_512_RATE, msg1, sizeof(msg1));
	qsc_shake_squeezeblocks(&state, QSC_KECCAK_512_RATE, hash, 8);
...
bool qsctest_cshake_128_kat()
{
	...
	uint8_t hashb[QSC_KECCAK_128_RATE] = { 0 };
	uint8_t msg32[4] = { 0 };
	uint8_t msg1600[200] = { 0 };
	uint8_t name[1] = { 0 };
	uint8_t output[32] = { 0 };
	...
	qsc_intutils_clear64(state.state, QSC_KECCAK_STATE_SIZE);
	qsc_cshake_initialize(&state, QSC_KECCAK_128_RATE, msg1600, sizeof(msg1600), name, 0, cust, sizeof(cust));
	qsc_cshake_squeezeblocks(&state, QSC_KECCAK_128_RATE, hashb, 1);
...
bool qsctest_cshake_256_kat()
{
	...
	uint8_t hashb[QSC_KECCAK_256_RATE] = { 0 };
	uint8_t msg32[4] = { 0 };
	uint8_t msg1600[200] = { 0 };
	uint8_t name[1] = { 0 };
	uint8_t output[64] = { 0 };
	...
	qsc_intutils_clear64(state.state, QSC_KECCAK_STATE_SIZE);
	qsc_cshake_initialize(&state, QSC_KECCAK_256_RATE, msg1600, sizeof(msg1600), name, 0, cust, sizeof(cust));
	qsc_cshake_squeezeblocks(&state, QSC_KECCAK_256_RATE, hashb, 1);
...
bool qsctest_cshake_512_kat()
{
	uint8_t exp512[64] = { 0 };
	uint8_t cust[15] = { 0 };
	uint8_t hashb[QSC_KECCAK_512_RATE] = { 0 };
	uint8_t msg512[64] = { 0 };
	uint8_t output[64] = { 0 };
	qsc_keccak_state state;
	bool status;
	...
	qsc_cshake_initialize(&state, QSC_KECCAK_512_RATE, msg512, sizeof(msg512), NULL, 0, cust, sizeof(cust));
	qsc_cshake_squeezeblocks(&state, QSC_KECCAK_512_RATE, hashb, 1);
...
bool qsctest_kmac_128_kat()
{
	...
	qsc_kmac_initialize(&state, QSC_KECCAK_128_RATE, key256, sizeof(key256), cust168, sizeof(cust168));
	qsc_kmac_update(&state, QSC_KECCAK_128_RATE, msg1600, sizeof(msg1600));
	qsc_kmac_finalize(&state, QSC_KECCAK_128_RATE, output, sizeof(output));
...
bool qsctest_kmac_256_kat()
{
	...
	qsc_kmac_initialize(&state, QSC_KECCAK_256_RATE, key256, sizeof(key256), cust168, sizeof(cust168));
	qsc_kmac_update(&state, QSC_KECCAK_256_RATE, msg1600, sizeof(msg1600));
	qsc_kmac_finalize(&state, QSC_KECCAK_256_RATE, output, sizeof(output));
...
bool qsctest_kmac_512_kat()
{
	...
	qsc_kmac_initialize(&state, QSC_KECCAK_512_RATE, key0, sizeof(key0), cust1, sizeof(cust1));
	qsc_kmac_update(&state, QSC_KECCAK_512_RATE, msg1, sizeof(msg1));
	qsc_kmac_finalize(&state, QSC_KECCAK_512_RATE, output, sizeof(output));
